...
class AdminSchoolServer {
  final String baseUrl;

  AdminSchoolServer({required this.baseUrl}) {
    print("🔗 GetStudentServer using baseUrl: $baseUrl");
  }
  Future<Map<String, dynamic>> getAdminSchoolData() async
  {
    try {
      print("here  getAdminSchoolData");
      ...
      final response2 = await http.get(
          Uri.parse('$baseUrl/schools/${adminId}/buses'),
